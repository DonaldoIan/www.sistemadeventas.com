...
<section data-bs-version="5.1" class="gallery2 cid-tF9iKHbJ1c" id="gallery2-34">
    
    <div class="mbr-overlay"></div>
    <div class="container-fluid">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-1"><strong>DASHBOARD</strong></h4>
        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <canvas id="graficalistening"></canvas>
                        <script type="text/javascript" src="script.js"></script>
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">Progress Listening Practice</h5>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <canvas id="graficareading"></canvas>
                        <script type="text/javascript" src="script2.js"></script>
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">Progress Reading Practice </h5>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">General Practice Progress</h5>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <canvas id="graficapromedioprep"></canvas>
                        <script type="text/javascript" src="script4.js"></script>
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">Self-assessment Grading</h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <canvas id="graficapromedioeva"></canvas>
                        <script type="text/javascript" src="script5.js"></script>
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">Assessment Grading</h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <canvas id="graficageneralprom"></canvas>
                        <script type="text/javascript" src="script6.js"></script>
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">Overall Skill Progress</h5>
...
<section data-bs-version="5.1" class="footer4 cid-tEuiV9CT1M" once="footers" id="footer4-32">
