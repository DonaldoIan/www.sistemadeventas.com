            ...
            <div class="card col-12 col-md-12 col-lg-9">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h1 class="card-title mbr-fonts-style mb-3 display-1"><strong>Listening Assessments: Intermediate Level</strong></h1>
...
$sql = "SELECT e.id_examen, e.nombre_examen, p.pregunta, p.opcion1, p.opcion2, p.opcion3, p.opcion4, p.correcta
        ...
        WHERE e.id_modulo = 2 AND e.id_categoria = 1";
