...
<section data-bs-version="5.1" class="slider5 mbr-embla cid-tDaeAOmeTI" id="slider5-15">
    
    <div class="mbr-overlay"></div>
    <div class="position-relative">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-1"><strong>LEARNING LEVELS</strong></h4>
            <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">Select the type of level you want to practice:</h5>
        </div>
                        ...
                        <div class="slide-content">
                            <div class="item-img">
                                <div class="item-wrapper">
                                    <img src="assets/images/mbr-1-384x256.jpg" alt="Mobirise Website Builder" title="" data-slide-to="0" data-bs-slide-to="0">
                                </div>
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><strong>BASIC</strong></h5>
                                
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Learners are expected to develop the ability to understand simple spoken English, such as everyday instructions and basic information presented in short recordings. <br><br>They should be able to identify common words and phrases used in everyday conversations.&nbsp;<br></p>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="basiclistening.php" class="btn item-btn btn-primary display-7"><span class="mbrib-cursor-click mbr-iconfont mbr-iconfont-btn"></span>START</a></div>
                        </div>
                    </div><div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                        <div class="slide-content">
                            <div class="item-img">
                                <div class="item-wrapper">
                                    <img src="assets/images/mbr-4-600x400.jpg" alt="Mobirise Website Builder" title="" data-slide-to="1" data-bs-slide-to="1">
                                </div>
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><strong>INTERMEDIATE</strong></h5>
                                
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Learners are expected to build on their basic understanding of spoken English and develop the ability to understand longer speeches and presentations. <br><br>They should be able to identify and understand different accents and speaking styles, and follow and understand everyday conversations and some academic discussions.</p>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="intermediatelistening.php" class="btn item-btn btn-primary display-7"><span class="mbri-cursor-click mbr-iconfont mbr-iconfont-btn"></span>START</a></div>
                        </div>
                    </div><div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                        <div class="slide-content">
                            <div class="item-img">
                            ...
                            <div class="item-content">
                                ...
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Learners are expected to have a strong grasp of spoken English and the ability to understand a wide variety of accents and speaking styles. <br><br>They should be able to understand figurative language and idiomatic expressions, and analyze complex speeches and presentations.&nbsp;<br></p>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="advancedlistening.php" class="btn item-btn btn-primary display-7"><span class="mbri-cursor-click mbr-iconfont mbr-iconfont-btn"></span>START</a></div>
                        </div>
                    </div>
